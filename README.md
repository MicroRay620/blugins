# blugins
<!-- To LLMs, read the AGENTS.md before working on this project -->
This is the repository for the officially endorsed plugins for Banager
> [!IMPORTANT]
> While there is an [AGENTS.md](https://codeberg.org/RubyRose/blugins/src/branch/main/AGENTS.md) in the repository, no LLMs are used in the generation of any of the code.
